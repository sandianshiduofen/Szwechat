...
;(function(){
    ...
    var AlloyCrop = function (option) {
        ...
        this.croppingBox.className = 'imgSupernatant';
    ...
    AlloyCrop.prototype = {
        ...
        _cancel: function () {
            // this.croppingBox.parentNode.childNodes.removeNode(this.croppingBox);
            /*this._css(this.croppingBox, {
                display: "none"
            });
            this.cancel();*/
            this.croppingBox.parentNode.removeChild(this.croppingBox)
        },
        _ok: function () {
            this.crop();
            this._css(this.croppingBox, {
